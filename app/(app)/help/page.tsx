                ...
                {currentTopic.workflow.map((step) => (
                  ...
                  >
                    ...
                    {step.screenshotPlaceholder && (
                      <div className="ml-10 mt-2 p-4 border-2 border-dashed border-slate-300 rounded-2xl bg-white text-center space-y-2 relative overflow-hidden group">
                        <div className="w-10 h-10 rounded-xl bg-slate-100 text-slate-400 mx-auto flex items-center justify-center">
                          <ImageIcon className="w-5 h-5" />
                        </div>
                        <div>
                          <div className="text-xs font-extrabold text-slate-800">
                            [ Area Screenshot: {step.screenshotPlaceholder.caption} ]
                          </div>
                          <div className="text-[11px] text-slate-500 max-w-md mx-auto mt-0.5 leading-normal">
                            {step.screenshotPlaceholder.description}
                          </div>
                        </div>
                        <div className="text-[9px] text-blue-600 font-bold uppercase tracking-wider bg-blue-50 py-1 px-3 rounded-full inline-block">
                          Tempat Gambar / Tangkapan Layar Aplikasi
                        </div>
                      </div>
                    )}
                  </div>
